class TimeSlot {
  ...
  renderActive() {
    ...
    if (this.column == 0) {
      ...
      circle(gridsize * this.column + SM + marginSize + overflow + gridsize - SM * 2, gridsize * this.row0 + SM * this.dir + marginSize + overflow, pointSize);
  ...
  renderActiveMax() {
    ...
    this.selected ? fill(255, 0, 0, lerpAmount2) : fill(100, lerpAmount2);
    circle(gridsize * this.column + SM + marginSize + overflow, gridsize * this.row0 + SM * this.dir + marginSize + overflow, pointSize);
    circle(gridsize * this.column + SM + marginSize + overflow, gridsize * this.row0 + SM * this.dir + marginSize + overflow + gridsize * (this.row1 + 1 - (this.row0 + 1)) - SM * 2 * this.dir, pointSize);
  }
